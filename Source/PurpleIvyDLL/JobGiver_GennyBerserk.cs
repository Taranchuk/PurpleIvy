...
namespace PurpleIvy
{
    public class JobGiver_GennyBerserk : ThinkNode_JobGiver
    {
        protected override Job TryGiveJob(Pawn pawn)
        {
            ...
            else if (pawn2 != null && pawn2.Downed)
            {
        ...
        private Pawn FindPawnTarget(Pawn pawn)
        {
            ...
            return (Pawn)AttackTargetFinder.BestAttackTarget(pawn, TargetScanFlags.NeedThreat, delegate (Thing x)
            {
                Pawn pawn2 = x as Pawn;
                return pawn2 != null && pawn2.Spawned;
            });
        }
